...
//  Ascension
//
//  Created by Kole Peoples on 5/7/19.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var died = Bool(false)
    let coinSound = SKAction.playSoundFileNamed("Cartoon Chomp Sound Effect.mp3", waitForCompletion: false)
    ...
    let birdAtlas = SKTextureAtlas(named:"kpplayer")
